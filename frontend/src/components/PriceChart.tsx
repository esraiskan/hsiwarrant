...
export default function PriceChart({ klines, trades, entryPrice }: Props) {
  ...
  return (
    <div>
      ...
      {/* RSI */}
      <ChartCard title="RSI (14)" height={140}>
        <ComposedChart data={chartData} margin={chartMargin}>
          <defs>
      ...
      <ChartCard title="TURNOVER" height={120}>
        <ComposedChart data={chartData} margin={chartMargin}>
          ...
          <Tooltip {...darkTooltipStyle} />
          <Bar dataKey="volume" fill={colors.primary} fillOpacity={0.3} radius={[2, 2, 0, 0]} name="成交额" />
